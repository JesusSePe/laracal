...
<body>
    ...
    <main class="max-w-5xl m-auto p-6">
        <span id="title" class="text-2xl font-semibold bg-gray-400 px-4 py-1 pt rounded-lg"></span>
        <script>
